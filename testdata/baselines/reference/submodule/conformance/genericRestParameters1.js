...
declare const f20: (x: number, y: string, z: boolean) => string[];
declare const f21: (y: string, z: boolean) => Array<string>;
declare const f22: (z: boolean) => Array<string>;
declare const f23: () => Array<string>;
declare const g20: (x: number, y?: string, z?: boolean) => string[];
declare const g21: (y?: string | undefined, z?: boolean | undefined) => Array<string>;
declare const g22: (z?: boolean | undefined) => Array<string>;
declare const g23: () => Array<string>;
declare function f30<T, U extends ((x: T) => any)[]>(x: T, ...args: U): U;

...
declare const tc3: [number, number, number, ...Array<string>];
declare const tc4: [...Array<string>, number, number, number];
declare function concat2<T extends readonly unknown[], U extends readonly unknown[]>(t: T, u: U): Array<T[number] | U[number]>;
declare const tc5: Array<1 | 2 | 3 | 4 | 5 | 6>;
declare function foo1(a: number, b: string, c: boolean, ...d: number[]): void;
...
declare const c0: (a: number, b: string, c: boolean, d: Array<string>) => number;
declare const c1: (b: string, c: boolean, d: Array<string>) => number;
declare const c2: (c: boolean, d: Array<string>) => number;
declare const c3: (d: Array<string>) => number;
declare const c4: () => number;
declare const fn2: (x: number, b: boolean, ...args: string[]) => number;
declare const c10: (x: number, b: boolean, ...args: Array<string>) => number;
declare const c11: (b: boolean, ...args: Array<string>) => number;
declare const c12: (...b: Array<string>) => number;
declare const c13: (...b: Array<string>) => number;
declare const fn3: (...args: string[]) => number;
declare const c20: (...b: Array<string>) => number;
declare const c21: (...b: Array<string>) => number;
declare const c22: (...b: Array<string>) => number;

...
// To modify this test, run "npm run makemanual quickInfoContextualTyping"
...
Point.prototype = {
	...
	f.VerifyQuickInfoAt(t, "11", "var c3t3: Array<number>", "")
	...
	f.VerifyQuickInfoAt(t, "22", "var c3t9: Array<Array<number>>", "")
	f.VerifyQuickInfoAt(t, "23", "var c3t10: Array<IFoo>", "")
	f.VerifyQuickInfoAt(t, "24", "var c3t11: Array<((n: number, s: string) => string)>", "")
	...
	f.VerifyQuickInfoAt(t, "34", "(property) IFoo.a: Array<number>", "")
	...
	f.VerifyQuickInfoAt(t, "43", "var c7t2: Array<IFoo>", "")
	f.VerifyQuickInfoAt(t, "44", "var c7t2: Array<IFoo>", "")
	...
	f.VerifyQuickInfoAt(t, "48", "(property) t3: Array<number>", "")
	...
	f.VerifyQuickInfoAt(t, "58", "(property) t9: Array<Array<number>>", "")
	f.VerifyQuickInfoAt(t, "59", "(property) t10: Array<IFoo>", "")
	f.VerifyQuickInfoAt(t, "60", "(property) t11: Array<((n: number, s: string) => string)>", "")
	...
	f.VerifyQuickInfoAt(t, "70", "(property) IFoo.a: Array<number>", "")
	...
	f.VerifyQuickInfoAt(t, "78", "var c12t3: Array<number>", "")
	...
	f.VerifyQuickInfoAt(t, "88", "var c12t9: Array<Array<number>>", "")
	f.VerifyQuickInfoAt(t, "89", "var c12t10: Array<IFoo>", "")
	f.VerifyQuickInfoAt(t, "90", "var c12t11: Array<((n: number, s: string) => string)>", "")
	...
	f.VerifyQuickInfoAt(t, "100", "(property) IFoo.a: Array<number>", "")

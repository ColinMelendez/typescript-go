...
// To modify this test, run "npm run makemanual quickInfoGenerics"
...
var y2 = x./*15*/method(x2, [x3, x3]);`
	...
	f.VerifyQuickInfoAt(t, "6", "(property) List2<T extends IList<number>>.__item: Array<T>", "")
	f.VerifyQuickInfoAt(t, "7", "(method) List2<T extends IList<number>>.getItem(i: number): T", "")
	f.VerifyQuickInfoAt(t, "8", "(method) List2<T extends IList<number>>.method<S extends IList<T>>(s: S, p: Array<T>): S", "")
	f.VerifyQuickInfoAt(t, "9", "(type parameter) S in List2<T extends IList<number>>.method<S extends IList<T>>(s: S, p: Array<T>): S", "")
	...
	f.VerifyQuickInfoAt(t, "15", "(method) List2<IList<number>>.method<IList<IList<number>>>(s: IList<IList<number>>, p: Array<IList<number>>): IList<IList<number>>", "")
}

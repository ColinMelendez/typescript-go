...
var t9: (a1: string[], a2: string[]) => void = (/*t91*/f1 = 4, /*t92*/f2 = [false, true]) => { };`
	...
	defer done()
	f.VerifyQuickInfoAt(t, "1", "(parameter) restArgs: Array<any>", "")
	f.VerifyQuickInfoAt(t, "2", "(parameter) restArgs: Array<any>", "")
	f.VerifyQuickInfoAt(t, "3", "(parameter) y: Array<string>", "")
	f.VerifyQuickInfoAt(t, "4", "(parameter) y1: Array<string>", "")
	f.VerifyQuickInfoAt(t, "5", "(parameter) y2: string", "")
	f.VerifyQuickInfoAt(t, "t1", "(parameter) f1: [a1: string, a2: string]", "")
	f.VerifyQuickInfoAt(t, "t2", "(parameter) f1: [a1: string, ...a2: Array<string>]", "")
	f.VerifyQuickInfoAt(t, "t31", "(parameter) f1: number", "")
	f.VerifyQuickInfoAt(t, "t32", "(parameter) f2: [a2: boolean, ...c: Array<string>]", "")
	f.VerifyQuickInfoAt(t, "t4", "(parameter) f1: Array<string>", "")
	f.VerifyQuickInfoAt(t, "t5", "(parameter) f1: string", "")
	f.VerifyQuickInfoAt(t, "t61", "(parameter) f1: string", "")
	f.VerifyQuickInfoAt(t, "t62", "(parameter) f2: Array<string>", "")
	...
	f.VerifyQuickInfoAt(t, "t8", "(parameter) f1: Array<number>", "")
	f.VerifyQuickInfoAt(t, "t91", "(parameter) f1: Array<string>", "")
	f.VerifyQuickInfoAt(t, "t92", "(parameter) f2: Array<string>", "")
}

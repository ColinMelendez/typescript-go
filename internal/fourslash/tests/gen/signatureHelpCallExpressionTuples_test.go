...
fnNoParamsWrapped/*7*/(/*8*/);`
	...
	f.VerifyQuickInfoAt(t, "4", "var fnVariadicWrapped: (str: string, ...num: Array<number>) => void", "")
	f.GoToMarker(t, "5")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{Text: "fnVariadicWrapped(str: string, ...num: Array<number>): void", ParameterCount: 2, ParameterName: "str", ParameterSpan: "str: string", IsVariadic: true, IsVariadicSet: true})
	f.GoToMarker(t, "6")
	f.VerifySignatureHelp(t, fourslash.VerifySignatureHelpOptions{ParameterName: "num", ParameterSpan: "...num: Array<number>", IsVariadic: true, IsVariadicSet: true})

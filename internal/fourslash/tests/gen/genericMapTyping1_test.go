...
var d/*6*/dd = aaa.map(xx => xx.length);     // should not error, should be any[]`
	...
	defer done()
	f.VerifyNoErrors(t)
	f.VerifyQuickInfoAt(t, "1", "var bb: Array<number>", "")
	f.VerifyQuickInfoAt(t, "2", "var cc: Array<number>", "")
	f.VerifyQuickInfoAt(t, "3", "var dd: Array<number>", "")
	f.VerifyQuickInfoAt(t, "4", "var bbb: Array<any>", "")
	f.VerifyQuickInfoAt(t, "5", "var ccc: Array<any>", "")
	f.VerifyQuickInfoAt(t, "6", "var ddd: Array<any>", "")
